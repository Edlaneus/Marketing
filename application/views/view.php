...
<div class="[ col-xs-12 col-sm-offset-2 col-sm-8 ]">
	...
	<div class="info" class="center" style="margin: 0 auto; margin-right: 8%;">
			...
			<ul style="list-style:none; " align="right">
				<li style="width:33%;" align="right"><span class="fa fa-thumbs-up"></span> <?php echo $rowsFeed['Likes'];?></li>
		...
		<div class="social" style="margin: 0 auto; margin-bottom: 2;">
			<ul>
				<li class="facebook" style="width:33%; list-style:none;"><a href="https://fb.com/<?php echo $rowsFeed['PostID'];?>" target="_blank"><span class="fa fa-facebook"></span></a></li>
			</ul>
